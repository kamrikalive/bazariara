...
export const metadata: Metadata = {
  title: 'Политика конфиденциальности | BAZARIara',
  description: 'Ознакомьтесь с политикой конфиденциальности интернет-магазина BAZARIara. Мы ценим вашу приватность и защищаем ваши данные.',
};
      ...
      <main className="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="bg-gray-800 rounded-lg shadow-xl p-6 md:p-8 lg:p-10 max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-gray-300">
            <p>Добро пожаловать в BAZARIara! Мы ценим вашу конфиденциальность и стремимся защищать ваши личные данные. Настоящая Политика конфиденциальности объясняет, как мы собираем, используем, раскрываем и защищаем вашу информацию при использовании нашего веб-сайта.</p>
